...
public class MainFrame extends JFrame {
    ...
    private String estado = 	"             \n" + " . . . . .|. \n" +
		...
		" . . . . . . \n" +
		" S           \n";
    private MazeState state = new MazeState(estado);
    private MazeAgent agent = new MazeAgent(state);
    ...
    public void buttonInitialState_ActionPerformed(ActionEvent e) {
        ...
        try {
            if (fc.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                gameArea.setMaze(agent.readInitialStateFromFile(fc.getSelectedFile()));
    ...
    public void comboBoxSearchMethods_ActionPerformed(ActionEvent e) {
        ...
        gameArea.setMaze(agent.resetEnvironment());
        buttonSolve.setEnabled(true);
        buttonShowSolution.setEnabled(false);
        buttonReset.setEnabled(false);
        textArea.setText("");
        ...
        SwingWorker worker = new SwingWorker<Solution, Void>() {
            ...
            public Solution doInBackground() {
                ...
                try {
                    ...
                    MazeProblem problem = new MazeProblem(agent.getEnvironment().clone());
